    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
          Renovision Design & Build serves Bellevue, Kirkland, Redmond, and surrounding areas. We're based in Bellevue and bring our expertise to your home.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="overflow-hidden border-0 shadow-lg h-96">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2699.3858394848666!2d-122.20432!3d47.6149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54906d3d3d3d3d3d%3A0x1234567890abcdef!2s1400%20112th%20Ave%20NE%2C%20Bellevue%2C%20WA%2098004!5e0!3m2!1sen!2sus!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-[#1E3A2E] text-white border-0 shadow-sm">
              ...
              <div className="space-y-2 text-sm">
                <p>
                  <strong>Phone:</strong>{' '}
                  <a href="tel:+14252766501" className="text-[#b68a3c] hover:underline">
                    (425) 276-6501
                  </a>
                </p>
                <p>
