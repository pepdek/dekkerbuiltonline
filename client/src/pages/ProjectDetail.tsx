...
export default function ProjectDetail() {
  ...
  const projects: Record<string, any> = {
    ...
    'modern-kitchen-dining-open-concept': {
      ...
      year: '2025',
      location: 'Tacoma, WA',
      description: 'This Tacoma home received a complete kitchen and dining room transformation, creating a seamless open-concept space perfect for entertaining and family gatherings.',
      heroImage: '/manus-storage/kitchen-project_59bb9660.webp',
