    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#F6F8F3] py-16">
        <div className="container mx-auto px-4">
          <p className="text-[#b68a3c] font-bold text-sm tracking-wide mb-4">TACOMA & SURROUNDING AREAS</p>
          <h1 className="text-4xl md:text-5xl font-bold text-[#1E3A2E] mb-6">
            General Contractor in Tacoma, WA
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mb-6">
            Renovision Design & Build is Tacoma's trusted design-build contractor for custom homes, kitchen remodels, bathroom renovations, and whole-home transformations. Serving Tacoma, Lakewood, Puyallup, Gig Harbor, and surrounding Pierce County communities with in-house crews, transparent pricing, and exceptional craftsmanship.
          </p>
          <div className="flex items-center gap-2 text-gray-700">
            <MapPin className="w-5 h-5 text-[#b68a3c]" />
            <p>Serving Tacoma, WA and Pierce County</p>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Deep understanding of Tacoma's neighborhoods, local zoning, building codes, and architectural styles. We know what works in Pierce County.
                  </p>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl">
            Renovision Design & Build serves Tacoma and the greater Pierce County area. We work throughout the following communities:
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Tacoma', 'Lakewood', 'Puyallup', 'Gig Harbor', 'Spanaway', 'Sumner', 'Bonney Lake', 'Eatonville'].map((area, index) => (
