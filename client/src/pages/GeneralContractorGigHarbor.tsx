...
export default function GeneralContractorGigHarbor() {
  const services = [
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#F6F8F3] py-16">
        <div className="container mx-auto px-4">
          <p className="text-[#b68a3c] font-bold text-sm tracking-wide mb-4">GIG HARBOR & SURROUNDING AREAS</p>
          <h1 className="text-4xl md:text-5xl font-bold text-[#1E3A2E] mb-6">
            General Contractor in Gig Harbor, WA
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mb-6">
            Renovision Design & Build brings luxury renovations to Gig Harbor's charming waterfront community. Specializing in kitchen remodels, bathroom renovations, whole-home transformations, and ADU construction. Our design-build approach ensures seamless project delivery with in-house crews and transparent pricing.
          </p>
          <div className="flex items-center gap-2 text-gray-700">
            <MapPin className="w-5 h-5 text-[#b68a3c]" />
            <p>Serving Gig Harbor, WA and Kitsap County</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#1E3A2E] mb-12">
            Why Choose Renovision for Your Gig Harbor Home
          </h2>
            ...
            <div>
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#1E3A2E] mb-2">
                    Waterfront Community Expertise
                  </h3>
                  <p className="text-gray-600">
                    Experience with Gig Harbor's unique architectural character, waterfront properties, and local building requirements. We understand the community's values and aesthetic.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    One firm, one team, one vision. Our integrated approach eliminates miscommunication and change orders that result from hiring separate contractors.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-[#F6F8F3] py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#1E3A2E] mb-12">
            Services We Offer in Gig Harbor
          </h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#1E3A2E] mb-12">
            Serving Kitsap County & Surrounding Areas
          </h2>

          <p className="text-lg text-gray-600 mb-8 max-w-2xl">
            Renovision Design & Build serves Gig Harbor and the greater Kitsap County area. We work throughout the following communities:
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Gig Harbor', 'Port Orchard', 'Bremerton', 'Poulsbo', 'Silverdale', 'Kingston', 'Indianola', 'Bainbridge Island'].map((area, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 mb-8">
                Schedule a free consultation to discuss your Gig Harbor home project. We'll walk your space, understand your vision, and provide a transparent estimate.
              </p>
