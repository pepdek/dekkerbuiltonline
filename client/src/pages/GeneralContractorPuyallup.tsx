...
export default function GeneralContractorPuyallup() {
  const services = [
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#F6F8F3] py-16">
        <div className="container mx-auto px-4">
          <p className="text-[#b68a3c] font-bold text-sm tracking-wide mb-4">PUYALLUP & SURROUNDING AREAS</p>
          <h1 className="text-4xl md:text-5xl font-bold text-[#1E3A2E] mb-6">
            General Contractor in Puyallup, WA
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mb-6">
            Renovision Design & Build is Puyallup's trusted design-build contractor for custom homes, kitchen remodels, bathroom renovations, and whole-home transformations. Serving Puyallup, Tacoma, Lakewood, and surrounding Pierce County communities with in-house crews, transparent pricing, and exceptional craftsmanship.
          </p>
          <div className="flex items-center gap-2 text-gray-700">
            <MapPin className="w-5 h-5 text-[#b68a3c]" />
            <p>Serving Puyallup, WA and Pierce County</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#1E3A2E] mb-12">
            Why Choose Renovision for Your Puyallup Home
          </h2>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#1E3A2E] mb-2">
                    Local Puyallup Expertise
                  </h3>
                  <p className="text-gray-600">
                    Deep understanding of Puyallup's neighborhoods, local zoning, building codes, and architectural styles. We know what works in Pierce County.
                  </p>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl">
            Renovision Design & Build serves Puyallup and the greater Pierce County area. We work throughout the following communities:
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Puyallup', 'Tacoma', 'Lakewood', 'Gig Harbor', 'Spanaway', 'Sumner', 'Bonney Lake', 'Eatonville'].map((area, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 mb-8">
                Schedule a free consultation to discuss your Puyallup home project. We'll walk your space, understand your vision, and provide a transparent estimate.
              </p>
